...
if __name__ == "__main__":
    ...
    parser.add_argument('--cache_images', type=bool, help='Caching images. If enabled than more RAM will be consumed but training process will be faster. Do not provide this flag if you don''t want caching images.', default=False)
